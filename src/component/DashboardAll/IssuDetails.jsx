        ...
        <div className="container-fluid mt-4">
            <div>
                ...
                <div className="issue-upload-full-div">
                    ...
                    <div
                        className="issue-upload-div px-2"
                        onClick={handleFileClick}
                    >
                        <Image src={upFile.src} width={60} height={81} alt="" />
                        <p className="csv-textp">
                            Drag or upload an excel file here.
                        </p>
                ...
                <div className="previe-issue-div pt-1">
                    ...
                    {isGenerate == 2 && (
                        <div className="previe-issue-text">
                            ...
                            <Link
                                className="previe-issue-btn-link"
                                href="/allitems"
                            >
