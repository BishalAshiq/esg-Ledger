                  ...
                  <Modal
                    ...
                    <Box sx={style}>
                      <div className='Modal-header-div'>
                        {success == true ?
                          <>
                            <p className="created-modal-success "> Changes have been saved successfully!</p>
                          </>
                          :
                          <>
                            <p>Do you wish to save the changes?</p>
                            <div className='created-modal-save-btn-div'>
                              <button className='yes-modal-btn' onClick={handleFormEdit}>Yes</button>
                              <button className='no-modal-btn' onClick={handleClose}>No</button>
                            </div>
                          </>
                        }
                      </div>
                  ...
                  <Modal
                    ...
                    <Box sx={styleDelete}>
                      <div className='Modal-header-div'>
                        {success == true ?
                          <>
                            <p className="created-modal-success "> Brand have been deleted successfully!</p>
                          </>
                          :
                          <>
                            <p>
                            ...
                            <div className='created-modal-save-btn-div'>
                              <button className='yes-modal-btn' onClick={handleCloseD}>Cancel</button>
                              <button className='no-modal-btn' onClick={hanleBrandDelete}>Delete</button>
                            </div>
                          </>
                        }
                      </div>
